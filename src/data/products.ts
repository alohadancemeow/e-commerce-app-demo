/**
 * The Product type is a type that represents a product in our application. 
 * It has an id, title, description, price, and imageUrl.
 * @property {string} id - string
 * @property {string} title - string
 * @property {string} description - string
 * @property {number} price - number
 * @property {string} imageUrl - string
 */
